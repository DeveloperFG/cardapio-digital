...
import hamburguer from './../../img/burguer-footer.png'
    ...
    const Produtos = [
        {
            ...
            nome: 'X-Bacon',
            preco: 15,
            descricao: '  Pão de hambúrguer com gergilim, burguer bovino, 2 fatias de queijo, 4 fatias de bacon Perdigão'
        },
        {
            id: 2,
            nome: 'X-Frango',
            preco: 13,
            descricao: 'Pão de hambúrguer ,bacon,  peito de frango grelhado, mussarela, alface, tomate, maionese'
        },
        {
            id: 3,
            nome: 'X-Tudo',
            preco: 21,
            descricao: ' Pão, 2 carnes, 2 mussarelas, 2 ovos, 2 bacon, 2 presunto, alface, tomate, batata palha e milho'
        },
        ...
        <div className='container'>
            <header>
                <div className='div-completo'>
                    ...
                    <h1>HAMBURGUER</h1>
                    <img className='piz' src={hamburguer} />
                </div>
            </header>
            ...
            <footer className='carrinho'>
                {topico === '| DELIVERY__' ? (
                    <>
                        ...
                        <div className='btn'>
                            <button> {lista.length} {lista.length == 0 || lista.length == 1 ? 'item' : 'items'} </button>
                        </div>
                    </>
                ) :
                    <>
